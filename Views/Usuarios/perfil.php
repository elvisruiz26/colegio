            ...
            <form id="formDataFiscal" name="formDataFiscal">
              <div class="row mb-4">
                <div class="col-md-6">
                  ...
                  <input class="form-control" type="text" id="txtWhatsapp" name="txtWhatsapp" value="<?= isset($_SESSION['userData']['whatsapp']) ? $_SESSION['userData']['whatsapp'] : ''; ?>">
                </div>
                <div class="col-md-6">
                  <label>Fecha Nacimiento</label>
                  <input class="form-control" type="text" id="txtFechaNac" name="txtFechaNac" value="<?= isset($_SESSION['userData']['fecha_nac']) ? $_SESSION['userData']['fecha_nac'] : ''; ?>">
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 mb-4">
                  <label>Dirección</label>
                  <input class="form-control" type="text" id="txtDirFiscal" name="txtDirFiscal" value="<?= isset($_SESSION['userData']['direccionuser']) ? $_SESSION['userData']['direccionuser'] : ''; ?>">
                </div>
              </div>
              <div class="row mb-10">
                <div class="col-md-12">
